        ...
        <h2 class="text-center text-primary">Lista de Itens</h2>
          ...
          <%-- Pedido + Cliente --%>
            <div class="form-group">
                ...
                <asp:DropDownList ID="pedidosDropDownList" runat="server" AutoPostBack="true" CssClass="form-control" OnSelectedIndexChanged="pedidosDropDownList_SelectedIndexChanged"></asp:DropDownList>
            </div>
        <hr />
            ...
            <ItemTemplate>
                <div class="alert alert-secondary">
                    ...
                    <asp:Label ID="pedidoLabel" runat="server" 
                        Text='<%# Eval("NumeroPedido") %>'></asp:Label>
