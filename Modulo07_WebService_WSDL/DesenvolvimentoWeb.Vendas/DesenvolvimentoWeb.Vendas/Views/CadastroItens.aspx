    ...
    <div class="row">
        <div class="col-md-5">
            ...
            <div class="form-group">
                ...
                ControlToValidate="quantidadeTextBox" ErrorMessage="Informe a quantidade" Display="Dynamic" CssClass="text-danger"></asp:RequiredFieldValidator>
                <asp:RangeValidator ID="quantidadeRangeValidator" runat="server" ErrorMessage="Insira uma quantidade entre 1 e 100" CssClass="text-danger" Display="Dynamic" MinimumValue="1" MaximumValue="100" Type="Integer" ControlToValidate="quantidadeTextBox"></asp:RangeValidator>
            </div>
            <%-- Botão --%>
            <div class="form-group">
